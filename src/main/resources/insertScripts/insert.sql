...
CREATE CACHED TABLE "PUBLIC"."DESIGNER_TYPE_PROPERTIES"(
    "NAMESPACE_ID" VARCHAR(255) NOT NULL,
    "TYPE_ID" VARCHAR(255) NOT NULL,
    "LABEL" VARCHAR(255),
	"ALIGN" VARCHAR(255),
	"LABEL_ALIGN" VARCHAR(255),
	"NAME" VARCHAR(255),
	"WIDTH" VARCHAR(255),
	...
	"FONT_WEIGHT_DESC" VARCHAR(255),
	"OPEN_MENU" BOOLEAN NOT NULL,
	"HEIGHT" VARCHAR(255)
);
...
ALTER TABLE "PUBLIC"."DESIGNER_TYPE_PROPERTIES" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_C71" PRIMARY KEY("NAMESPACE_ID", "TYPE_ID");
