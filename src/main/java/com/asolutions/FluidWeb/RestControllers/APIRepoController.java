...
import com.asolutions.FluidWeb.Repositories.APIHeaderParamRepository;
import com.asolutions.FluidWeb.Repositories.APIPathParamRepository;
import com.asolutions.FluidWeb.Repositories.APIQueryParamRepository;
import com.asolutions.FluidWeb.Repositories.APIRepoRepository;
import com.asolutions.FluidWeb.Repositories.APIRequestTemplateRepository;
import com.asolutions.FluidWeb.Repositories.APIResponseTemplateRepository;
...
public class APIRepoController {
	...
	public List<ApiPathParam> getPathParamsForApi(@PathVariable String apiId){
		List<ApiPathParam> params = apiPathParamRepository.findByIdApiid(apiId);
		for(ApiPathParam pathParam: params) {
